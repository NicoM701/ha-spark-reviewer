...
Experimental migration candidate, not installed or live-verified yet.
...
1. Add `https://github.com/NicoM701/ha-spark-reviewer` to the Home Assistant app store repositories and install Spark PR Review. The ARM64 container still requires live validation.
